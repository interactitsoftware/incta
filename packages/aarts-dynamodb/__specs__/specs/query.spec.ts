...
describe('query spec', () => {
  ...
  const seedAirtoursData = async () => {
    ...
    // 20 flights
    const flight_sf_mw = await transactPutItem(new TestModel_FlightItem({ flight_code: "F1", airplane: plane_mc21_reg111.id, from_airport: bg_airport_sf.id, to_airport: ru_airport_mw.id, from_country: bg_country.id, to_country: ru_country.id }), TestModel_FlightItem.__refkeys)
    const flight_sf_bj = await transactPutItem(new TestModel_FlightItem({ flight_code: "F2", airplane: plane_tu144_reg333, from_airport: bg_airport_sf.id, to_airport: ch_airport_bj.id, from_country: bg_country.id, to_country: ch_country.id }), TestModel_FlightItem.__refkeys)
    const flight_sf_mw1 = await transactPutItem(new TestModel_FlightItem({ flight_code: "F3", airplane: plane_tu144_reg222, from_airport: bg_airport_sf.id, to_airport: ru_airport_mw.id, from_country: bg_country.id, to_country: ru_country.id }), TestModel_FlightItem.__refkeys)

    const flight_bj_mw = await transactPutItem(new TestModel_FlightItem({ flight_code: "F4", airplane: plane_mc21_reg111.id, from_airport: ch_airport_bj.id, to_airport: ru_airport_mw.id, from_country: ch_country.id, to_country: ru_country.id }), TestModel_FlightItem.__refkeys)
    const flight_bj_ke = await transactPutItem(new TestModel_FlightItem({ flight_code: "F5", airplane: plane_tu144_reg333, from_airport: ch_airport_bj.id, to_airport: us_airport_ke.id, from_country: ch_country.id, to_country: us_country.id }), TestModel_FlightItem.__refkeys)
    const flight_bj_ke1 = await transactPutItem(new TestModel_FlightItem({ flight_code: "F6", irplane: plane_b787_reg444, from_airport: ch_airport_bj.id, to_airport: us_airport_ke.id, from_country: ch_country.id, to_country: us_country.id }), TestModel_FlightItem.__refkeys)
    const flight_bj_sy = await transactPutItem(new TestModel_FlightItem({ flight_code: "F7", airplane: plane_b787_reg444, from_airport: ch_airport_bj.id, to_airport: au_airport_sy.id, from_country: ch_country.id, to_country: au_country.id }), TestModel_FlightItem.__refkeys)

    const flight_mw_ke = await transactPutItem(new TestModel_FlightItem({ flight_code: "F8", airplane: plane_mc21_reg111.id, from_airport: ru_airport_mw.id, to_airport: us_airport_ke.id, from_country: ru_country.id, to_country: us_country.id }), TestModel_FlightItem.__refkeys)
    const flight_mw_sf = await transactPutItem(new TestModel_FlightItem({ flight_code: "F9", airplane: plane_tu144_reg222, from_airport: ru_airport_mw.id, to_airport: bg_airport_sf.id, from_country: ru_country.id, to_country: bg_country.id }), TestModel_FlightItem.__refkeys)
    const flight_mw_pt = await transactPutItem(new TestModel_FlightItem({ flight_code: "F10", airplane: plane_b787_reg555, from_airport: ru_airport_mw.id, to_airport: ru_airport_pt.id, from_country: ru_country.id, to_country: ru_country.id }), TestModel_FlightItem.__refkeys)

    const flight_sy_bj = await transactPutItem(new TestModel_FlightItem({ flight_code: "F11", airplane: plane_b787_reg444, from_airport: au_airport_sy.id, to_airport: ch_airport_bj.id, from_country: au_country.id, to_country: ch_country.id }), TestModel_FlightItem.__refkeys)
    const flight_sy_ln = await transactPutItem(new TestModel_FlightItem({ flight_code: "F12", airplane: plane_mc21_reg111.id, from_airport: au_airport_sy.id, to_airport: uk_airport_ln.id, from_country: au_country.id, to_country: uk_country.id }), TestModel_FlightItem.__refkeys)
    const flight_sy_ke = await transactPutItem(new TestModel_FlightItem({ flight_code: "F13", airplane: plane_tu144_reg333, from_airport: au_airport_sy.id, to_airport: us_airport_ke.id, from_country: au_country.id, to_country: us_country.id }), TestModel_FlightItem.__refkeys)

    const flight_sr_sf = await transactPutItem(new TestModel_FlightItem({ flight_code: "F14", airplane: plane_mc21_reg111.id, from_airport: sr_airport_bg.id, to_airport: bg_airport_sf.id, from_country: sr_country.id, to_country: bg_country.id }), TestModel_FlightItem.__refkeys)
    const flight_sr_ke = await transactPutItem(new TestModel_FlightItem({ flight_code: "F15", airplane: plane_tu144_reg333, from_airport: sr_airport_bg.id, to_airport: us_airport_ke.id, from_country: sr_country.id, to_country: us_country.id }), TestModel_FlightItem.__refkeys)

    const flight_ke_sf = await transactPutItem(new TestModel_FlightItem({ flight_code: "F16", airplane: plane_tu144_reg222, from_airport: us_airport_ke.id, to_airport: bg_airport_sf.id, from_country: us_country.id, to_country: bg_country.id }), TestModel_FlightItem.__refkeys)
    const flight_ke_mw = await transactPutItem(new TestModel_FlightItem({ flight_code: "F17", airplane: plane_tu144_reg222, from_airport: us_airport_ke.id, to_airport: ru_airport_mw.id, from_country: us_country.id, to_country: ru_country.id }), TestModel_FlightItem.__refkeys)
    const flight_ke_mw1 = await transactPutItem(new TestModel_FlightItem({ flight_code: "F18", airplane: plane_mc21_reg111.id, from_airport: us_airport_ke.id, to_airport: ru_airport_mw.id, from_country: us_country.id, to_country: ru_country.id }), TestModel_FlightItem.__refkeys)

    const flight_pt_mw = await transactPutItem(new TestModel_FlightItem({ flight_code: "F19", airplane: plane_tu144_reg333, from_airport: ru_airport_pt.id, to_airport: ru_airport_mw.id, from_country: ru_country.id, to_country: ru_country.id }), TestModel_FlightItem.__refkeys)
    const flight_pt_sf = await transactPutItem(new TestModel_FlightItem({ flight_code: "F20", airplane: plane_mc21_reg111.id, from_airport: ru_airport_pt.id, to_airport: bg_airport_sf.id, from_country: ru_country.id, to_country: bg_country.id }), TestModel_FlightItem.__refkeys)
