...
import { ExistingDynamoItem, DynamoItem, RefKey, DomainItem } from './BaseItemManager';
...
export const transactDeleteItem = async <T extends DomainItem & DynamoItem>(existingItem: T, __item_refkeys: RefKey<T>[]): Promise<T> => {
