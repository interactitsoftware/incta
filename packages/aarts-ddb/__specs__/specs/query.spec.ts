...
import { _specs_AirplaneItem, _specs_AirportItem, _specs_FlightItem } from "../testmodel/_DynamoItems";
...
describe('query.spec', () => {
  ...
  test('index meta__smetadata: query all items having particular string refkey value', async () => {
  ...
  test('index meta__nmetadata: query all items having particular number refkey value', async () => {
    // get all airplanes with number_of_seats > 20
    const high_volume_planes = await queryItems({
  ...
  test('index meta__nmetadata: query all items having particular refkey greater than number value', async () => {
    // get all airplanes with number_of_seats > 20
    const high_volume_planes = await queryItems({
      ddbIndex: "meta__nmetadata",
      pk: `${_specs_AirplaneItem.__type}}number_of_seats`,
  ...
  test('index meta__nmetadata: query all items having particular refkey lower than number value', async () => {
    // get all airplanes with number_of_seats < 20
  ...
  test('index meta__nmetadata: query all items having particular refkey between 2 number values', async () => {
