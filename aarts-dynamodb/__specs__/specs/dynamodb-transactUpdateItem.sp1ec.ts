...
// describe('Updating an item, also cares for refkeys and aggregations updates', () => {
...
//       await transactUpdateItem(airplane, { id: airplane.id, revisions: airplane.revisions, home_airport: "frankfurt" }, TestModel_AirplaneRefkeys).then(async updateResult => { //act
...
//   // test('changing unique key of an item, deletes the old one and inserts new', async () => {
//   //   const airplane = new TestModel_AirplaneItem()
